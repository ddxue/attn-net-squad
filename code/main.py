...
# High-level options
tf.app.flags.DEFINE_string("gpu", "0", "Which GPU to use, if you have multiple.")
...
def main(unused_argv):
    ...
    if FLAGS.mode == "train":
        ...
        with tf.Session(config=config) as sess:
            ...
            _, _ = qa_model.check_f1_em(sess, dev_context_path, dev_qn_path, dev_ans_path, "dev", num_samples=0, print_to_screen=True)
